...
class ChangeFilterNewsTest{
    ...
    fun `Given params, then call changeFilterNews and return list with subscribed symbols`() = runTest {
        ...
        // THEN
        coVerify {
            newsRepository.changeFilterNews(
    ...
    private fun mockChangeFilterNewsSuccess(
        ...
        coEvery { newsRepository.changeFilterNews(any(),any()) }.returnsMany(
    ...
    private fun mockChangeFilterNewsError(
        ...
        coEvery { newsRepository.changeFilterNews(any(),any()) }.returns(

...
val assetDetailInfoFilters = listOf(
    FilterAssetDetailInfo(
        stringId = R.string.quotes,
        typeAssetDetailFilter = TypeAssetDetailFilter.Quotes,
    ),
    FilterAssetDetailInfo(
        stringId = R.string.trades,
        typeAssetDetailFilter = TypeAssetDetailFilter.Trades,
    ),
)
